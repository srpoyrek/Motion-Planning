...
NotebookDataLength[     78260,       1546]
NotebookOptionsPosition[     51177,        964]
NotebookOutlinePosition[     77437,       1525]
CellTagsIndexPosition[     77326,       1519]
WindowTitle->The Minkowski Sum of Two Triangles
WindowFrame->Normal*)
...
Cell["The Minkowski Sum of Two Triangles", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = {-6.1, -4.7}, $CellContext`b$$ = \
{-5.6, 7.9}, $CellContext`c$$ = {-8.4, -2.}, $CellContext`x$$ = {
    6.1, -1.7}, $CellContext`y$$ = {5.6, -4.1}, $CellContext`z$$ = {4.4, -2.},
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`a$$], {-6.1, -4.7}}, {-9, -9}, {9, 9}}, {{
       Hold[$CellContext`b$$], {-5.6, 7.9}}, {-9, -9}, {9, 9}}, {{
       Hold[$CellContext`c$$], {-8.4, -2.}}, {-9, -9}, {9, 9}}, {{
       Hold[$CellContext`x$$], {6.1, -1.7}}, {-9, -9}, {9, 9}}, {{
       Hold[$CellContext`y$$], {5.6, -4.1}}, {-9, -9}, {9, 9}}, {{
       Hold[$CellContext`z$$], {4.4, -2.}}, {-9, -9}, {9, 9}}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`a$678$$ = {0, 0}, $CellContext`b$679$$ = {0, 
    0}, $CellContext`c$680$$ = {0, 0}, $CellContext`x$681$$ = {0, 
    0}, $CellContext`y$682$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = {-6.1, -4.7}, $CellContext`b$$ = \
{-5.6, 7.9}, $CellContext`c$$ = {-8.4, -2.}, $CellContext`x$$ = {
         6.1, -1.7}, $CellContext`y$$ = {5.6, -4.1}, $CellContext`z$$ = {
         4.4, -2.}}, "ControllerVariables" :> {
        Hold[$CellContext`a$$, $CellContext`a$678$$, {0, 0}], 
        Hold[$CellContext`b$$, $CellContext`b$679$$, {0, 0}], 
        Hold[$CellContext`c$$, $CellContext`c$680$$, {0, 0}], 
        Hold[$CellContext`x$$, $CellContext`x$681$$, {0, 0}], 
        Hold[$CellContext`y$$, $CellContext`y$682$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, 
      "Body" :> ($CellContext`tri = {{$CellContext`a$$ + $CellContext`x$$, \
$CellContext`b$$ + $CellContext`x$$, $CellContext`b$$ + $CellContext`y$$, \
$CellContext`a$$ + $CellContext`y$$, $CellContext`a$$ + $CellContext`x$$}, \
{$CellContext`a$$ + $CellContext`x$$, $CellContext`b$$ + $CellContext`x$$, \
$CellContext`b$$ + $CellContext`z$$, $CellContext`a$$ + $CellContext`z$$, \
$CellContext`a$$ + $CellContext`x$$}, {$CellContext`a$$ + $CellContext`y$$, \
$CellContext`b$$ + $CellContext`y$$, $CellContext`b$$ + $CellContext`z$$, \
$CellContext`a$$ + $CellContext`z$$, $CellContext`a$$ + $CellContext`y$$}, \
{$CellContext`c$$ + $CellContext`x$$, $CellContext`b$$ + $CellContext`x$$, \
$CellContext`b$$ + $CellContext`y$$, $CellContext`c$$ + $CellContext`y$$, \
$CellContext`c$$ + $CellContext`x$$}, {$CellContext`c$$ + $CellContext`x$$, \
$CellContext`b$$ + $CellContext`x$$, $CellContext`b$$ + $CellContext`z$$, \
$CellContext`c$$ + $CellContext`z$$, $CellContext`c$$ + $CellContext`x$$}, \
{$CellContext`c$$ + $CellContext`y$$, $CellContext`b$$ + $CellContext`y$$, \
$CellContext`b$$ + $CellContext`z$$, $CellContext`c$$ + $CellContext`z$$, \
$CellContext`c$$ + $CellContext`y$$}, {$CellContext`c$$ + $CellContext`x$$, \
$CellContext`a$$ + $CellContext`x$$, $CellContext`a$$ + $CellContext`y$$, \
$CellContext`c$$ + $CellContext`y$$, $CellContext`c$$ + $CellContext`x$$}, \
{$CellContext`c$$ + $CellContext`x$$, $CellContext`a$$ + $CellContext`x$$, \
$CellContext`a$$ + $CellContext`z$$, $CellContext`c$$ + $CellContext`z$$, \
$CellContext`c$$ + $CellContext`x$$}, {$CellContext`c$$ + $CellContext`y$$, \
$CellContext`a$$ + $CellContext`y$$, $CellContext`a$$ + $CellContext`z$$, \
$CellContext`c$$ + $CellContext`z$$, $CellContext`c$$ + $CellContext`y$$}}; \
$CellContext`s = 
        Subsets[{$CellContext`a$$ + $CellContext`x$$, $CellContext`a$$ + \
$CellContext`y$$, $CellContext`a$$ + $CellContext`z$$, $CellContext`b$$ + \
$CellContext`x$$, $CellContext`b$$ + $CellContext`y$$, $CellContext`b$$ + \
$CellContext`z$$, $CellContext`c$$ + $CellContext`x$$, $CellContext`c$$ + \
$CellContext`y$$, $CellContext`c$$ + $CellContext`z$$}, {
          3}]; $CellContext`ps = {$CellContext`a$$ + $CellContext`x$$, \
$CellContext`b$$ + $CellContext`x$$, $CellContext`c$$ + $CellContext`x$$, \
$CellContext`a$$ + $CellContext`y$$, $CellContext`b$$ + $CellContext`y$$, \
$CellContext`c$$ + $CellContext`y$$, $CellContext`a$$ + $CellContext`z$$, \
$CellContext`b$$ + $CellContext`z$$, $CellContext`c$$ + $CellContext`z$$}; 
       Graphics[{
...
$CellContext`x$$}], 
          ...
          Polygon[$CellContext`s], Black, 
          Line[$CellContext`tri], 
          RGBColor[1, 0.47, 0], 
          PointSize[0.03], 
          Point[$CellContext`ps]}, PlotRange -> 10, ImageSize -> {400, 400}]),
       "Specifications" :> {{{$CellContext`a$$, {-6.1, -4.7}}, {-9, -9}, {9, 
         9}, ControlType -> 
         Locator}, {{$CellContext`b$$, {-5.6, 7.9}}, {-9, -9}, {9, 9}, 
         ControlType -> 
         Locator}, {{$CellContext`c$$, {-8.4, -2.}}, {-9, -9}, {9, 9}, 
         ControlType -> 
         Locator}, {{$CellContext`x$$, {6.1, -1.7}}, {-9, -9}, {9, 9}, 
         ControlType -> 
         Locator}, {{$CellContext`y$$, {5.6, -4.1}}, {-9, -9}, {9, 9}, 
         ControlType -> Locator}, {{$CellContext`z$$, {4.4, -2.}}, {-9, -9}, {
         9, 9}, ControlType -> Locator}}, 
      "Options" :> {
       TrackedSymbols -> Manipulate, AutorunSequencing -> {1, 2, 4}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{451., {229., 234.}},
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"a", "\[Element]", "A"}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"b", "\[Element]", "B"}], TraditionalForm]], "InlineMath"],
 ". "
}], "ManipulateCaption",
 CellID->60545480],

Cell["\<\
This Demonstration shows the Minkowski sum of two triangles, which is the \
smallest convex set containing the nine points obtained by forming the vector \
sums using the vertices of the triangles.\
\>", "ManipulateCaption",
 CellID->473521991],
...
Cell[TextData[{
 ButtonBox["Vector Addition",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/VectorAddition.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Minkowski Sum",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/MinkowskiSum.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
TheMinkowskiSumOfTwoTriangles&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheMinkowskiSumOfTwoTriangles/\
TheMinkowskiSumOfTwoTriangles-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["The Minkowski Sum of Two Triangles",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheMinkowskiSumOfTwoTriangles/"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheMinkowskiSumOfTwoTriangles/"],
 "\"",
 ...
 ButtonBox["http://demonstrations.wolfram.com/TheMinkowskiSumOfTwoTriangles/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheMinkowskiSumOfTwoTriangles/"], 
    None},
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["George Beck",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=George+Beck"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=George+Beck"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[42123, 733, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42384, 742, 719, 18, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[50355, 939, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 77041, 1508},
 {"Copyright", 77235, 1513}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34987, 592, 6283, 109, 70, "Output",
 CellID->314804113],
Cell[41273, 703, 590, 21, 70, "ManipulateCaption",
 CellID->60545480],
Cell[41866, 726, 254, 5, 70, "ManipulateCaption",
 CellID->473521991],
Cell[42123, 733, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42384, 742, 719, 18, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43106, 762, 44, 0, 70, "RelatedLinksSection"],
Cell[43153, 764, 568, 20, 70, "RelatedLinks",
 CellID->49495640],
Cell[43724, 786, 564, 20, 70, "RelatedLinks",
 CellID->39864637],
Cell[44291, 808, 4826, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[49120, 899, 45, 0, 70, "CitationSection"],
Cell[49168, 901, 860, 24, 70, "Citations"],
Cell[50031, 927, 321, 10, 70, "Author"],
Cell[50355, 939, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature USE4A4oZq@dJPuQoY2uW2Ov# *)
